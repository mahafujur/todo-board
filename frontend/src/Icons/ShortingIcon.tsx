...
const SvgShortingIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} width="24" height="24" role="presentation" focusable="false" viewBox="0 0 24 24"
...
export default SvgShortingIcon;
